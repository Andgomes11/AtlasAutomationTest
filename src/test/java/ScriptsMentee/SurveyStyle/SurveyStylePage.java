...
public class SurveyStylePage {
        ...
        public SurveyStylePage() throws ATUTestRecorderException {
            ...
            recorder = new ATUTestRecorder("C:\\Users\\ander\\OneDrive\\Área de Trabalho\\AtlasAutomationTest\\Test Evidence\\Mentee", "Survey Style Test" + d.format(date), false);
            recorder.start();
    ...
    public void UserTraits() {
            browser.findElement(By.xpath("/html/body/div[11]/div[8]")).click();
    }

    public void Style() {
            browser.findElement(By.xpath("//div[contains(text(),'Style')]")).click();
    }

    public void AnchorAssessment1() {
        WebElement dropdown = browser.findElement(By.xpath("//*[@id=\"group-answers-and-careers\"]/div[2]/div[1]/div/div[2]/div[2]"));
